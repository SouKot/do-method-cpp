...
{
public:
  Problem_Interface(const Teuchos::RCP<Epetra_CrsMatrix>& A, // Teuchos::RCP<Epetra_CrsMatrix> A21,
                    const Teuchos::RCP<Teuchos::ParameterList>& SolverParams, const Teuchos::RCP<Epetra_Vector>& udet, int &m,
                    double *t, double &dt, const Teuchos::RCP<Epetra_MultiVector>& W, const Teuchos::RCP<Epetra_CrsMatrix>& mass,
                    int iter);
  ~Problem_Interface();
  ...
  void set_y(const Epetra_MultiVector& yy)
  {
    *y = yy;
  };
