...
#include "globdefs.H"
#include "Interface.hpp"        // pulls in Burger/Mean.hpp or QG/Mean.hpp
    ...
    try {
...

        {
            ...
            if (initSolnFile != "None") {
                Epetra_MultiVector *initsol = nullptr;
                EpetraExt::MatrixMarketFileToMultiVector(initSolnFile.c_str(),
                                                         soln->Map(), initsol);
                *soln = *(*initsol)(0);
                delete initsol;
            }
